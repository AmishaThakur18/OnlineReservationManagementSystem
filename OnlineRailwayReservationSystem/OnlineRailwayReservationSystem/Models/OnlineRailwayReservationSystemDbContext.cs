...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClassId).HasName("PK__Class__CB1927C0BCB3919E");
        ...
        {
            entity.HasKey(e => e.CoachId).HasName("PK__Coach__F411D9413E6153BE");
        ...
        {
            entity.HasKey(e => e.FareId).HasName("PK__Fare__1261FA16B3B77025");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__9B556A388522AC9F");
        ...
        {
            entity.HasKey(e => e.QueryId).HasName("PK__Query__5967F7DB7C989E8C");
        ...
        {
            entity.HasKey(e => e.QueryListId).HasName("PK__QueryLis__ACD72B5F3B79442A");
        ...
        {
            entity.HasKey(e => e.QuotaId).HasName("PK__Quota__AE96C9C26F31BF70");
        ...
        {
            entity.HasKey(e => e.ReservationId).HasName("PK__Reservat__B7EE5F24F86E0AA9");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1AE95D23F0");
        ...
        {
            entity.HasKey(e => e.RouteId).HasName("PK__Route__80979AADC56E975F");
        ...
        {
            entity.HasKey(e => e.SeatId).HasName("PK__Seat__311713F3614ADD1A");
        ...
        {
            entity.HasKey(e => e.SupportId).HasName("PK__Support__D82DBC8C9E990C14");
        ...
        {
            entity.HasKey(e => e.TicketId).HasName("PK__Ticket__712CC607F8C8E4B0");
        ...
        {
            entity.HasKey(e => e.TrainId).HasName("PK__Train__8ED2723A765E2A95");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C4BACA676");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserRole__1788CC4C1BD7CA60");
